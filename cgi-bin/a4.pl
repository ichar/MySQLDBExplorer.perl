...
sub perl_func {
  ...
  "    <tr>\n",
  ($s > 0 ?
  "      <td id=\"bar\" bgcolor=\"#0000FF\"><img src=\"/images/spacer.gif\" height=\"10\" width=\"".$bar_width."\"></td>\n" :
  "      <td id=\"bar\" bgcolor=\"#FFFFFF\"><img src=\"/images/spacer.gif\" height=\"10\" width=\"1\"></td>\n" ),
  "    </tr>\n",
  "    </table>\n",
  "  </td>\n",
...
function js_process_func() {
    ...
    OK.innerHTML += '<span style="font-size:20px;"><strong>Done!</strong></span>&nbsp;';
}
...
<input type="button" name="run" id="run" value="  Start  " onclick="javascript:refresh();">
<br>
<br>
